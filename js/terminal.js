...
const base = `<span style="color: #b8d5ef">sh1ftie.tech</span>:<span style="color: dodgerblue">~</span>$ `;
let array = [];
let input = "";
let lastIdx = -1;
let lastCmd = "";
...
function inputLine(k) {
	terminal.innerHTML += `\n<div class=\"new-line\"><span style=\"color: #b8d5ef\">sh1ftie.tech</span>:<span style=\"color: dodgerblue\">~</span>$ ${k?k:""}</div>`
}
...
function info() {
	terminal.innerHTML += '\n<img alt="icon" class="img" src="static/icon.png">\n' + "  <div><span>phuclongtruong540</span>@<span>gmail.com</span></div>\n" + "  <div>---------------------</div>\n" + "  <div><span>OS</span>: Bloatdoze</div>\n" + "  <div><span>Ages</span>: 17</div>\n" + "  <div><span>Twitter</span>: <a href=\"https://twitter.com/hiimsh1ftie\" target='_blank'>@sh1ftie</a></div>\n" + "  <div><span>Discord</span>: <a href=\"https://discord.com/users/892338782462935050\" target='_blank'>sh1ftie#0001</a></div>\n" + "  <div><span>Youtube</span>: <a href=\"https://www.youtube.com/channel/UCYWlSystqBafNkpi_DTnOjQ\" target='_blank'>more hic pls, ty</a></div>\n" + "  <div><span>Facebook</span>: <a href=\"https://www.facebook.com/100011520185885\" target='_blank'>Trương Phúc Long</a></div>\n" + "  <div><span>ukm roi sao </span>: <a href=\"https://facebook.com/100028645784033\" target='_blank'>Gia Bảo</a></div>\n" + "  <div><span>osu!</span>: <a href=\"https://osu.ppy.sh/users/23553950\" target='_blank'>Pixellia</a></div>\n" + ' <div style="padding-bottom:10px; clear: both;">'
}
